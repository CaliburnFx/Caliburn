...
namespace Caliburn.PresentationFramework.RoutedMessaging.Triggers
{
    ...
    public class GestureMessageTrigger : BaseMessageTrigger
    {
        ...
        {
            readonly InputGesture gesture;
            readonly List<GestureMessageTrigger> triggers = new List<GestureMessageTrigger>();
            ...
            public override bool Equals(object obj)
            {
                ...
                return other != null && gesture.Equals(other.gesture);
            }
            ...
            {
                return (GetType().FullName + "|" + gesture.GetHashCode()).GetHashCode();
            }
            ...
            public bool CanExecute(object parameter)
            {
                ...
                foreach(var trigger in triggers)
                {
                    var effect = trigger.Message.AvailabilityEffect
                                 ?? RoutedMessaging.Message.GetAvailabilityEffect(trigger.Message.Source.UIElement);

                    if(effect != null && effect == AvailabilityEffect.Disable)
                        result = result && trigger.canExecute;

namespace Tests.Caliburn.MVP.Models
{
    ...
    [TestFixture]
    public class When_commiting_changes_on_a_model : TestBase
    {
        ...
        [Test]
        public void will_not_be_dirty_after_committing_simple_values()
        {
        ...
        [Test]
        public void will_not_be_dirty_after_committing_simple_values_on_an_association()
        {
            Assert.That(_contact.IsDirty, Is.False);
        ...
        [Test]
        public void will_not_be_dirty_after_committing_values_to_a_collection()
        {
            Assert.That(_contact.IsDirty, Is.False);
